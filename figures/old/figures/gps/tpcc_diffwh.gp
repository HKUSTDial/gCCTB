...
set terminal pdf size 8,6 enhanced font 'Times-New-Roman,36,Bold' 

set output "../pdf/tpcc_pm_diffwh.pdf"  ###输出的文件名

set xlabel "Warehouse"     # X轴标签
set xlabel offset 0,0.7 font 'Times-New-Roman,48,Bold'
set ylabel "Throughput(10^6 txn/s)" font 'Times-New-Roman,48,Bold'    # Y轴标签
set ytics font 'Times-New-Roman,48,Bold' 
set grid ytics linewidth 4
set xtics font 'Times-New-Roman,48,Bold' offset 0,0.2

set key font "Times-New-Roman,32,Bold"
set key under box center
set key offset -1,-0.25
set key samplen 3 

set logscale x 2

throu_pth = "../tpcc_pm_diffwh_throughput.txt"
...
set output "../pdf/tpcc_no_diffwh.pdf"  ###输出的文件名
throu_pth = "../tpcc_no_diffwh_throughput.txt"
...
set output "../pdf/tpcc_pm_diffwh_abr.pdf"  ###输出的文件名
...
abr_pth =  "../tpcc_pm_diffwh_abr.txt"
...
set output "../pdf/tpcc_no_diffwh_abr.pdf"  ###输出的文件名

abr_pth = "../tpcc_no_diffwh_abr.txt"
