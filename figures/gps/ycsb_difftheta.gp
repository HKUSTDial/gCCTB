# set terminal pngcairo size 900,600 enhanced font 'Roman,20,Bold'   ## 格式，大小和字体
set terminal pdfcairo size 9,6 enhanced font 'Sans,36,Bold'

set output "../pdf/ycsb_difftheta.pdf"  ###输出的文件名

set xlabel "\{Theta}"     # X轴标签
set xlabel offset 0,0.7 font 'Times-New-Roman,48,Bold'
set ylabel "Throughput(10^6 txn/s)" font 'Times-New-Roman,48,Bold' offset 0,-0.2    # Y轴标签
...
throu_pth = "../mid/ycsb_difft_throughput.txt"
abr_pth = "../mid/ycsb_difft_abr.txt"
...
set output "../pdf/ycsb_difftheta_abr.pdf"  ###输出的文件名
