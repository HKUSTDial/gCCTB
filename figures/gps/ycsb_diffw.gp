...
set terminal pdf size 9,6 enhanced font 'Times-New-Roman,36,Bold' 

set output "../pdf/ycsb_diffw.pdf"  ###输出的文件名
...
throu_pth = "../mid/ycsb_diffw_throughput.txt"
abr_pth = "../mid/ycsb_diffw_abr.txt"
...
set output "../pdf/ycsb_diffw_abr.pdf"  ###输出的文件名
