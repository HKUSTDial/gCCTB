...
set output "../pdf/ycsb_ro_diffwd.pdf"  ###输出的文件名

set xlabel "Warp Density"     # X轴标签
set xlabel offset 0,1 font 'Times-New-Roman,44,Bold'
set ylabel "Throughput(10^6 txn/s)" font 'Times-New-Roman,42,Bold' offset 0,-0.5    # Y轴标签
set ytics font 'Times-New-Roman,44,Bold' 
set grid ytics linewidth 4
set xtics font 'Times-New-Roman,44,Bold' offset 0,0.4
...
set output "../pdf/ycsb_mc_diffwd.pdf"  ###输出的文件名
...
set output "../pdf/ycsb_hc_diffwd.pdf"  ###输出的文件名
...
set output "../pdf/ycsb_mc_diffwd_abr.pdf"  ###输出的文件名
...
set output "../pdf/ycsb_hc_diffwd_abr.pdf"  ###输出的文件名
