...
set output "../png/ycsb_ro_diffbs.png"  ###输出的文件名
...
set output "../png/ycsb_mc_diffbs.png"  ###输出的文件名
...
set output "../png/ycsb_mc_diffbs_abr.png"  ###输出的文件名
...
set output "../png/ycsb_hc_diffbs.png"  ###输出的文件名
...
set output "../png/ycsb_hc_diffbs_abr.png"  ###输出的文件名
